...
var useLatest = function useLatest2(value) {
  var ref = import_react12.default.useRef(value);
  index(function() {
    ref.current = value;
  });
  return ref;
...
function wrapMenuList(MenuList22) {
  function WrappedMenuList(props) {
    ...
    const checkTimeoutRef = (0, import_react14.useRef)(null);
    const menuListRef = (0, import_react14.useRef)(null);
    const shouldHandle = (0, import_react14.useCallback)(() => {
    ...
    const checkAndHandle = (0, import_react14.useCallback)(() => {
      if (shouldHandle()) {
    ...
    const setCheckAndHandleTimeout = (0, import_react14.useMemo)(() => {
      const res = () => {
        checkAndHandle();
...
var MenuList3 = wrapMenuList(
  // biome-ignore lint/suspicious/noExplicitAny: fix types
  components.MenuList
);
var useComponents = (components2) => (0, import_react13.useMemo)(
  () => ({
    MenuList: MenuList3,
    ...components2
  }),
...
var useAsyncPaginateBase = (params, deps = []) => {
  ...
  const isInitRef = (0, import_react16.useRef)(true);
  const paramsRef = (0, import_react16.useRef)(params);
  paramsRef.current = params;
  const [_stateId, setStateId] = (0, import_react16.useState)(0);
  ...
  const handleScrolledToBottom = (0, import_react16.useCallback)(() => {
    const currentInputValue = paramsRef.current.inputValue;
  ...
  const options2 = (0, import_react16.useMemo)(() => {
...
var useAsyncPaginate = (params, deps = []) => {
  ...
  const [inputValueState, setInputValue] = (0, import_react15.useState)(
    defaultInputValueParam || ""
  );
  const [menuIsOpenState, setMenuIsOpen] = (0, import_react15.useState)(!!defaultMenuIsOpenParam);
  ...
  const onInputChange = (0, import_react15.useCallback)(
  ...
  const onMenuClose = (0, import_react15.useCallback)(() => {
    if (onMenuCloseParam) {
      onMenuCloseParam();
    }
    setMenuIsOpen(false);
  }, [onMenuCloseParam]);
  const onMenuOpen = (0, import_react15.useCallback)(() => {
    if (onMenuOpenParam) {
      onMenuOpenParam();
    }
    setMenuIsOpen(true);
